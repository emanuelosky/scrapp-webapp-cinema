	...
	export const bubbleVariants = tv({
		...
		variants: {
			variant: {
				...
				epikUser: "*:data-[slot=bubble-content]:bg-goldenrose-700 *:data-[slot=bubble-content]:text-white",
				epikAi: "*:data-[slot=bubble-content]:bg-zinc-900/50 *:data-[slot=bubble-content]:text-zinc-200",
				epikAiLatest: "*:data-[slot=bubble-content]:bg-zinc-900 *:data-[slot=bubble-content]:text-zinc-200",
			},
		},
		defaultVariants: {
			variant: "default",
