...
{#if bookingState.showExtensionModal && bookingState.timeRemainingSeconds !== null}
    <div class="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4" transition:fade={{duration: 200}}>
        <div class="bg-black border-none rounded-none shadow-2xl p-0 gap-0 max-w-sm w-full text-center relative" transition:fly={{y: 20, duration: 300}}>
            ...
            <div class="p-6 flex flex-col gap-6">
                <div class="w-16 h-16 bg-zinc-900 border-none rounded-full flex items-center justify-center mx-auto text-white">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <button 
                        class="w-full bg-zinc-900 border-none hover:bg-zinc-800 text-white font-bold uppercase tracking-widest py-3 text-sm transition-colors"
